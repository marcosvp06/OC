...
with open(path_in, "r") as inputFile:
    for line in inputFile:
        ...
        if instr == 'CLR':
            ...
            program_lines.append(['JMP', f"0X{address:02X}"])
    ...
    for parts in program_lines:
        ...
        if instruction in two_bytes:
            ...
            if dest.startswith(("0X", "0B")):
                addr = int(dest, 0)  # Interpreta o argumento do segundo byte (como binario ou hexa) e converte para inteiro
            ...
            # Se nao for binario ou hexa, entao sera tratado como decimal
                ...
                addr = int(dest)  # Interpreta o argumento do segundo byte como decimal e converte para inteiro
