; Aluno: Marcos Paulo Vieira Pedrosa
; Matricula: 22401906
...
leitura:
  ...
  in data, r0 ; Le do teclado o primeiro simbolo digitado
  in data, r1 ; Le do teclado o segundo simbolo digitado

  data r2, 47 ; Guarda em R2 o valor de '/' em ascii
  data r3, -48  ; Oposto do valor do ascii '0' (Em complemento de dois)

  cmp r1, r2  ; Compara o segundo simbolo digitado com '/'
  je menor_que_10  ; Se o segundo simbolo for '/', dividendo < 10
  ; Caso contrario, primeiro simbolo == dezenas, segundo simbolo  == unidades
  ...
  menor_que_10:
    ; como dividendo < 10, dividendo = primeiro digito digitado
    add r3, r0 ; Converte o dividendo para inteiro subtraindo '0'
...
mostra_resultado:
  ...
  data r3, 0x54 ; Seta em R3 o endereco 0x54
  st r2, r3 ; Armazena na memoria (em 0xff) o endereco de retorno dessa chamada da divisao_inteira (0x54)
  jmp divisao_inteira ; Quociente (R0) = dezenas / Resto (R1) = unidades
  ; endereco de retorno == 0x54
